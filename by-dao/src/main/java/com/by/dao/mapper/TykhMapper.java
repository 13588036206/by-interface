...
public interface TykhMapper {
    ...
    @Results({
        ...
        @Result(column="spdm", property="goodsMapping",one=@One(select="com.by.dao.mapper.GoodsMappingMapper.selectBySpdm",fetchType= FetchType.EAGER)),
        @Result(column="spdm", property="spxx", one=@One(select="com.by.dao.mapper.SpxxMapper.selectByPrimaryKey",fetchType= FetchType.EAGER)),
